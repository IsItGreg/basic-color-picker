...
The extension does **not** request `<all_urls>` host access and does **not** declare any `content_scripts`. It runs only on the active tab, only when you click its icon. See the [privacy policy](docs/privacy.md) for the full data story.
