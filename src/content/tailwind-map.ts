// Default Tailwind CSS v3 palette (includes the 950 shades). Each entry maps
// "<family>-<shade>" → "#rrggbb". Used both for nearest-palette lookup and for
// resolving Tailwind utility classes found on a picked element.
